    ...
    <div className="min-h-screen bg-[var(--dark-bg)] text-white">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <Card className="bg-[var(--dark-card)] border-[var(--dark-border)] rounded-2xl p-6 md:p-12 text-center">
            <CardContent className="p-0">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 md:mb-6 text-gradient-danger-gold">
                Caminho da Ruína ou Jornada da Liberdade?
              </h2>
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[var(--gold)] mb-8 md:mb-12">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-center mb-8 md:mb-16 text-gradient-gold px-2">
            Perfil do Fracasso ou Perfil do Sucesso: Qual é o seu?
          </h2>
          
          <div className="space-y-8 md:space-y-16">
            {/* Curto Prazo - Perfil do Fracasso */}
            <Card className="bg-[var(--dark-card)] border-red-500/30 rounded-2xl p-6 md:p-10">
              <CardContent className="p-0">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-red-500 mb-4 md:mb-6 flex items-center flex-wrap">
                  <TrendingDown className="mr-2 md:mr-4 h-6 w-6 md:h-8 md:w-8 flex-shrink-0" />
                  <span>Curto Prazo: O Perfil que Escolhe Perder</span>
                </h3>
            ...
            <Card className="bg-[var(--dark-card)] border-green-500/30 rounded-2xl p-6 md:p-10">
              <CardContent className="p-0">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-500 mb-4 md:mb-6 flex items-center flex-wrap">
                  <TrendingUp className="mr-2 md:mr-4 h-6 w-6 md:h-8 md:w-8 flex-shrink-0" />
                  <span>Longo Prazo: O Perfil do Vencedor</span>
                </h3>
                <div className="text-gray-300 text-base md:text-lg leading-relaxed space-y-4 md:space-y-6">
                  <p>
          ...
          <div className="mt-12 md:mt-16">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12 text-[var(--gold)] px-2">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-center mb-8 md:mb-16 text-gradient-danger-gold px-2">
            A Verdade Nua e Crua: O Real vs. A Ilusão
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Ilusão das Bets */}
            <Card className="bg-gradient-to-br from-red-500/10 to-[var(--dark-card)] border-red-500/20 rounded-2xl p-6 md:p-10">
              <CardContent className="p-0">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-red-500 mb-4 md:mb-6 flex items-center flex-wrap">
                  <EyeOff className="mr-2 md:mr-4 h-6 w-6 md:h-8 md:w-8 flex-shrink-0" />
                  <span>Ilusão: O Sonho Perigoso das Bets</span>
                </h3>
                <div className="text-gray-300 space-y-3 md:space-y-4">
                  ...
                  <div className="bg-red-500/20 p-3 md:p-4 rounded-lg mt-4 md:mt-6">
                    <p className="text-xs md:text-sm text-red-500 font-semibold">
            ...
            <Card className="bg-gradient-to-br from-green-500/10 to-[var(--dark-card)] border-green-500/20 rounded-2xl p-6 md:p-10">
              <CardContent className="p-0">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-500 mb-4 md:mb-6 flex items-center flex-wrap">
                  <Eye className="mr-2 md:mr-4 h-6 w-6 md:h-8 md:w-8 flex-shrink-0" />
                  <span>Realidade: Investimentos e o Controle Absoluto</span>
                </h3>
                <div className="text-gray-300 space-y-3 md:space-y-4">
                  <p className="text-sm md:text-base">
                  ...
                  <div className="bg-green-500/20 p-3 md:p-4 rounded-lg mt-4 md:mt-6">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <Card className="bg-gradient-to-br from-[var(--gold)]/10 via-[var(--dark-card)] to-green-500/10 border-[var(--gold)]/30 rounded-2xl p-6 md:p-12 text-center">
            <CardContent className="p-0">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-6 md:mb-8 bg-gradient-to-r from-[var(--gold)] to-green-500 bg-clip-text text-transparent">
                O Futuro Está em Suas Mãos
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-6 md:mb-8 px-2">
              ...
              <div className="p-4 md:p-6 bg-green-500/20 border border-green-500/30 rounded-xl">
